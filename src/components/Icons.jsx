// Minimal line/flat icons used in the footer and as hobby placeholders.
...
export function RunningIcon({ className }) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      <circle cx="14.5" cy="4.7" r="1.6" fill="currentColor" />
      <path
        d="M10 8.7l3-1.3 2 2.3 3.3 1-0.5 1.9-3.5-1-1.7 1.8 2 3.7-1 3.8M13 9.4l-2.3 2.6-3.2 1M9 15.1l-2.5 1.2-1 3.3"
        fill="none"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
...
export function MountainIcon({ className }) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      <path
        d="M3 19h18L14 6l-3.5 6L9 9 3 19Z"
        fill="none"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinejoin="round"
...
export function GamepadIcon({ className }) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      <path d="M6.5 9v3M5 10.5h3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      <circle cx="16" cy="9" r="0.9" fill="currentColor" />
      <circle cx="18" cy="11" r="0.9" fill="currentColor" />
      <path
        d="M5.5 9C3.6 9 2 10.7 2 13c0 2 .9 3.8 2.4 3.8.9 0 1.4-.5 2.1-1.4l.9-1.1a2 2 0 0 1 1.6-.8h6.1a2 2 0 0 1 1.6.8l.9 1.1c.7.9 1.2 1.4 2.1 1.4C21.1 16.8 22 15 22 13c0-2.3-1.6-4-3.5-4h-13Z"
        fill="none"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinejoin="round"
...
export const hobbyIcons = {
  ...
  'video-games': GamepadIcon,
  'board-games': DiceIcon,
}
