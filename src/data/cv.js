export const profile = {
  ...
  tagline:
    'Cloud engineer building and owning the connectivity backbone linking thousands of enterprise storage devices to the cloud.',
  links: [
...
export const stats = [
  { value: '5', label: 'Years at HPE' },
  { value: '30k', label: 'Devices connected' },
  { value: '4', label: 'AWS clusters owned' },
  { value: '200+', label: 'Dependent services' },
]
...
lead HPE Bristol's intern programme and its Pride employee resource group.`
